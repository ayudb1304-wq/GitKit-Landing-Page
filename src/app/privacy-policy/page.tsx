    ...
    <main className="min-h-screen bg-zinc-950 px-6 py-24 text-zinc-400">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="space-y-6">
          <section>
            <h2 className="mb-4 text-2xl font-semibold text-zinc-200">1. Information We Collect</h2>
            <p>
          ...
          <section>
            <h2 className="mb-4 text-2xl font-semibold text-zinc-200">2. How We Use Your Information</h2>
            <p>
          ...
          <section>
            <h2 className="mb-4 text-2xl font-semibold text-zinc-200">3. Information Sharing</h2>
            <p>
          ...
          <section>
            <h2 className="mb-4 text-2xl font-semibold text-zinc-200">4. Data Security</h2>
            <p>
          ...
          <section>
            <h2 className="mb-4 text-2xl font-semibold text-zinc-200">5. Changes to this Policy</h2>
            <p>
